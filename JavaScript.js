...
function renderTransactions() {
    ...
    const displayedTransactions = showingAllTransactions
        ? transactionsData
...
const viewAllBtn = document.querySelector('.transactions-section .see-all');
...
viewAllBtn.addEventListener('click', (e) => {
    ...
    viewAllBtn.textContent = showingAllTransactions
        ? 'Show Less'
        : 'View All';
